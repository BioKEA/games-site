...
export interface Game {
  ...
  // when unset, the pre-bundled artifact under public/<slug>/ ships.
  repo?: string;
}
...
export const games: Game[] = [
  ...
  },
  {
    ...
    playUrl: '/particle-survival-shooter/',
  ...
  },
  {
    ...
    playUrl: '/cal-field-lab-collectible/',
  ...
  },
  {
    ...
    playUrl: '/3d-biodiversity-collect-em-all/',
